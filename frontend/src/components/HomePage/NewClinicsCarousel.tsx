...
const NewClinicsCarousel: React.FC<Props> = ({ clinics, loading, onClinicClick }) => {
    ...
    <section className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Novas na ClínicasLink</h2>
        </div>
        {loading ? (
          <div className="text-center py-8 text-gray-400">Carregando clínicas...</div>
        ) : clinics.length === 0 ? (
          <div className="text-center py-8 text-gray-400">Nenhuma clínica nova no momento.</div>
        ) : (
...
export default NewClinicsCarousel;